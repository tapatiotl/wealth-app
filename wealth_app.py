...
# Custom CSS for styling with the working slider adjustments
st.markdown("""
    <style>
    .main {
    ...
    .stSlider .st-bk { /* Correct class for progress bar, adjust if needed (e.g., st-ar, st-bj) */
...
with st.container():
    ...
    # Native Streamlit sliders (second, with working CSS)
